...
[Noise as Color](?actionable=1&action=update_td_pars&Useramp=0){: .btn .btn-purple .mr-2}[Ramp Color](?actionable=1&action=update_td_pars&Useramp=1){: .btn .btn-purple .mr-2}
